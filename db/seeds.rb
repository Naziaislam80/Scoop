...
ch8 = Channel.create!(title: 'App Academy', work_space_id: ws8.id)
ch9 = Channel.create!(title: 'Random', work_space_id: ws9.id)
...
msg6 = Message.create!(body: 'Yo mama so fat Mount Everest tried to climb her.', user_id: user2.id, channel_id: ch1.id )
msg7 = Message.create!(body: 'MICHEAL???', user_id: user3.id, channel_id: ch1.id )
msg8 = Message.create!(body: 'Anonymous report time', user_id: user15.id, channel_id: ch1.id)
msg9 = Message.create!(body: 'Animal Crossing time!', user_id: user7.id, channel_id: ch1.id)
msg10 = Message.create!(body: 'Have you seen Elijah without his glasses?', user_id: user13.id, channel_id: ch1.id)
msg11 = Message.create!(body: 'SHHHH NO ONE CAN KNOW', user_id: user11.id, channel_id: ch1.id)
msg12 = Message.create!(body: 'read the docs', user_id: user5.id, channel_id: ch1.id)
msg13 = Message.create!(body: 'Lets play league', user_id: user8.id, channel_id: ch1.id )
msg14 = Message.create!(body: 'who is your favorite TA?', user_id: user4.id, channel_id: ch1.id)
msg15 = Message.create!(body: 'datz eazy', user_id: user8.id, channel_id: ch1.id )
msg16 = Message.create!(body: 'what did I miss guys?', user_id: user9.id, channel_id: ch1.id )
