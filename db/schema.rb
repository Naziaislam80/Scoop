...
ActiveRecord::Schema.define(version: 2020_04_07_014712) do
  ...
  create_table "channel_subscribers", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_channel_subscribers_on_user_id"
  end
  ...
  create_table "channels", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["work_space_id"], name: "index_channels_on_work_space_id"
  end
  ...
  create_table "work_spaces", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_work_spaces_on_name", unique: true
